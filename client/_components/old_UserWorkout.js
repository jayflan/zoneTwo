...
import UserWorkoutOverview from "./UserWorkoutOverview";
      ...
      <Flex direction="column" justifyContent="space-between" h="100vh">
        <Flex pt={28}>
          ...
          <Box className="nav-userworkout" ml={6} mr={6}>
            <ul>
              <Link as='li' to={`/workouts/user/${singleWorkout.id}`}>
              ...
              <Link as='li' to={`/workouts/user/${singleWorkout.id}/analysis`}>
                <Flex as="button" className="btn-useranalysis" p="4" border="1px" borderColor="gray.200">
                  <Text pl='0.2em' pr='1.5em'>Analysis</Text>
                  {/* <Box width="12"></Box> */}
                </Flex>
              </Link>
            </ul>
          ...
          {/* <Box flexGrow="1" mr={6}> */}
            ...
            {/* <Box> */}
              <UserWorkoutOverview singleWorkout={ singleWorkout }/>
            {/* </Box> */}
